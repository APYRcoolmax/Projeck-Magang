    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->check() && auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.absences.export.pdf')" :active="request()->routeIs('admin.absences.export.pdf')">
                    {{ __('Export PDF') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('admin.absences.export.excel')" :active="request()->routeIs('admin.absences.export.excel')">
                    {{ __('Export Excel') }}
                </x-responsive-nav-link>
            @endif
        </div>
