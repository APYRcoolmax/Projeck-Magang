    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- Desktop Navigation Links (Menu Horizontal) --}}
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        @if(auth()->user()->role === 'karyawan')
                            {{-- Menu Karyawan (Horizontal) --}}
                            <x-nav-link :href="route('absence.index')" :active="request()->routeIs('absence.index')">
                                {{ __('Absensi') }}
                            </x-nav-link>
                            
                            <x-nav-link :href="route('daily_status.index')" :active="request()->routeIs('daily_status.index')">
                        ...
                        @elseif(auth()->user()->role === 'admin')
                            ...
                            <x-nav-link :href="route('admin.daily_status.index')" :active="request()->routeIs('admin.daily_status.index')">
